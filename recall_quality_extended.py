...
for jj in range(num_degradations):
    t_lower_degradations.append(initializing_time + (jj + num_exposures)*(stim_length + stim_delay))
    t_upper_degradations.append(initializing_time + (jj + num_exposures)*(stim_length + stim_delay) +  stim_length)
