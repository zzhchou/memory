...
#define nrn_init _nrn_init__Add_E2Syn
#define _nrn_initial _nrn_initial__Add_E2Syn
#define nrn_cur _nrn_cur__Add_E2Syn
#define _nrn_current _nrn_current__Add_E2Syn
#define nrn_jacob _nrn_jacob__Add_E2Syn
#define nrn_state _nrn_state__Add_E2Syn
#define _net_receive _net_receive__Add_E2Syn 
#define state state__Add_E2Syn 
...
#define update update_Add_E2Syn
 extern double update( double , double , double );
 /* declare global and static user variables */
#define c_n c_n_Add_E2Syn
 double c_n = 0.6;
#define tau_n tau_n_Add_E2Syn
 double tau_n = 34;
 ...
 "c_n_Add_E2Syn", &c_n_Add_E2Syn,
 "tau_n_Add_E2Syn", &tau_n_Add_E2Syn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 Add_E2Syn /home/zzchou/memory/x86_64/add_stdp.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 67 in file add_stdp.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/zzchou/memory/add_stdp.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	POINT_PROCESS Add_E2Syn\n"
