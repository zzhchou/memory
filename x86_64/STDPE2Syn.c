...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 STDPE2 /home/zzchou/memory/x86_64/STDPE2Syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/zzchou/memory/STDPE2Syn.mod";
static const char* nmodl_file_text = 
  ...
  "	RANGE g, gbdel, gblen, gbint, B, C, gs, v_rec, d_count, p_count, pot, A_init\n"
  ...
  ":			printf(\"A increase should be %g \\n\",(wmax-w1-A1)*p*exp((tp - t)/ptau))\n"
  "			pot=A1+w1\n"
  "			p_count=p_count+1\n"
  "		}\n"
