...
#define nrn_init _nrn_init__E2_Prob
#define _nrn_initial _nrn_initial__E2_Prob
#define nrn_cur _nrn_cur__E2_Prob
#define _nrn_current _nrn_current__E2_Prob
#define nrn_jacob _nrn_jacob__E2_Prob
#define nrn_state _nrn_state__E2_Prob
#define _net_receive _net_receive__E2_Prob 
#define state state__E2_Prob 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 E2_Prob /home/zzchou/memory/x86_64/E2_Prob.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 55 in file E2_Prob.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/zzchou/memory/E2_Prob.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
