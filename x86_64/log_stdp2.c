...
#define nrn_init _nrn_init__Log_E2Syn2
#define _nrn_initial _nrn_initial__Log_E2Syn2
#define nrn_cur _nrn_cur__Log_E2Syn2
#define _nrn_current _nrn_current__Log_E2Syn2
#define nrn_jacob _nrn_jacob__Log_E2Syn2
#define nrn_state _nrn_state__Log_E2Syn2
#define _net_receive _net_receive__Log_E2Syn2 
#define state state__Log_E2Syn2 
...
#define J0 _p[8]
#define f _p[9]
#define deltaw_init _p[10]
#define seed _p[11]
#define i _p[12]
#define g _p[13]
#define interval _p[14]
#define k _p[15]
#define A _p[16]
#define B _p[17]
#define tpost _p[18]
...
#define update update_Log_E2Syn2
 extern double update( double , double , double );
 /* declare global and static user variables */
#define c_n c_n_Log_E2Syn2
 double c_n = 0.5;
#define tau_n tau_n_Log_E2Syn2
 double tau_n = 34;
 ...
 "c_n_Log_E2Syn2", &c_n_Log_E2Syn2,
 "tau_n_Log_E2Syn2", &tau_n_Log_E2Syn2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 Log_E2Syn2 /home/zzchou/memory/x86_64/log_stdp2.mod\n");
...
double update (  double _lJ , double _lJ0 , double _linterval ) {
 ...
 if ( _linterval > 0.0 ) {
     ...
     if ( _lJ <= _lJ0 ) {
       ...
       f = c_n * ( 1.0 + log ( 1.0 + alpha * ( ( _lJ / _lJ0 ) - 1.0 ) ) / alpha ) ;
       }
...
{   int _watch_rm = 0;
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = 0;}
 {
   if ( _lflag  == 0.0 ) {
     _args[2] = t ;
     interval = tpost - _args[2] ;
     _args[1] = _args[1] + k * ( 1.0 + normrand ( 0.0 , 0.6 ) ) * update ( _threadargscomma_ _args[1] + _args[0] , J0 , interval ) ;
 ...
 {
       interval = t - _fnargs1[2] ;
       _fnargs1[1] = _fnargs1[1] + k * ( 1.0 + normrand ( 0.0 , 0.6 ) ) * update ( _threadargscomma_ _fnargs1[1] + _fnargs1[0] , J0 , interval ) ;
       }
     	}}
 }
   else if ( _lflag  == 1.0 ) {
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 65 in file log_stdp2.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/zzchou/memory/log_stdp2.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
